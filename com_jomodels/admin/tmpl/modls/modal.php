...
/** @var \JLTRY\Component\Jomodels\Administrator\View\Modls\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_jomodels&view=modls&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
