...
/------------------------------------------------------------------------------------------------------*/
namespace JLTRY\Component\Jomodels\Administrator\View\Jomodels;
...
class HtmlView extends BaseHtmlView
{
    ...
    function display($tpl = null): void
    {
        ...
        $this->contributors   = JomodelsHelper::getContributors();

        // get the manifest details of the component
        $this->manifest = JomodelsHelper::manifest();
    ...
    {
        $canDo = JomodelsHelper::getActions('jomodels');
        ToolbarHelper::title(Text::_('COM_JOMODELS_DASHBOARD'), 'grid-2');
    ...
    {
        // set page title
        $this->getDocument()->setTitle(Text::_('COM_JOMODELS_DASHBOARD'));
