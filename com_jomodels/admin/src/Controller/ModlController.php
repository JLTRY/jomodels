...
/**
 * Modl Form Controller
 *
 * @since  1.6
 */
class ModlController extends FormController
{
     ...
     * @since  1.6
     */
    protected $text_prefix = 'COM_JOMODELS_MODL';
    ...
    protected function allowAdd($data = [])
    {
        ...
        // Access check.
        $access = $user->authorise('modl.access', 'com_jomodels');
        if (!$access)
        {
            return false;
        }
