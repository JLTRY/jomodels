...
/------------------------------------------------------------------------------------------------------*/
namespace JLTRY\Component\Jomodels\Administrator\Helper;
...
abstract class JomodelsHelper
{
    ...
    public static function addSubmenu($submenu)
    {
        ...
        \JHtmlSidebar::addEntry(Text::_('COM_JOMODELS_SUBMENU_DASHBOARD'), 'index.php?option=com_jomodels&view=jomodels', $submenu === 'jomodels');
        if ($user->authorise('modl.access', 'com_jomodels') && $user->authorise('modl.submenu', 'com_jomodels'))
        {
            \JHtmlSidebar::addEntry(Text::_('COM_JOMODELS_SUBMENU_MODLS'), 'index.php?option=com_jomodels&view=modls', $submenu === 'modls');
        }
    }
