...
namespace JLTRY\Joomla\Jofacebook\Utilities;
...
/***[JCBGUI.power.main_class_code.52.$$$$]***/
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        {
            throw new \InvalidArgumentException(Text::_('COM_JOFACEBOOK_CAN_NOT_SAVE_USER_WITHOUT_EMAIL_VALUE'));
        }
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        if ($mode === 2 && method_exists(ComponentbuilderHelper::class, 'registerUser'))
        {
            ...
            throw new NoUserIdFoundException(Text::_('COM_JOFACEBOOK_USER_CREATION_FAILED'));
        }
        ...
        throw new NoUserIdFoundException(
            Text::sprintf('COM_JOFACEBOOK_USER_S_S_CREATION_FAILEDS',
    ...
    public static function update(array $userDetails): int
    {
        ...
        throw new \RuntimeException(
            Text::sprintf('COM_JOFACEBOOK_UPDATE_OF_USER_S_S_FAILEDS',
