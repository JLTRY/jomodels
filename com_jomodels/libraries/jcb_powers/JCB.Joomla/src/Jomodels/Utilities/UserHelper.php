...
namespace JCB\Joomla\Jomodels\Utilities;
...
use JCB\Joomla\Jomodels\Utilities\Exception\NoUserIdFoundException;
...
/***[JCBGUI.power.main_class_code.52.$$$$]***/
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        {
            throw new \InvalidArgumentException(Text::_('COM_JOMODELS_CAN_NOT_SAVE_USER_WITHOUT_EMAIL_VALUE'));
        }
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        if ($mode === 2 && method_exists(ComponentbuilderHelper::class, 'registerUser'))
        {
            ...
            throw new NoUserIdFoundException(Text::_('COM_JOMODELS_USER_CREATION_FAILED'));
        }
        ...
        throw new NoUserIdFoundException(
            Text::sprintf('COM_JOMODELS_USER_S_S_CREATION_FAILEDS',
    ...
    public static function update(array $userDetails): int
    {
        ...
        throw new \RuntimeException(
            Text::sprintf('COM_JOMODELS_UPDATE_OF_USER_S_S_FAILEDS',
